...
const categories = ["T-Shirts", "Oversized", "Hoodies", "Accessories"];
const sizesList = ["S", "M", "L", "XL", "XXL"];
const colorsList = ["White", "Black", "Gold", "Beige"];
const materialsList = ["Cotton", "Premium Cotton", "Heavy Cotton"];
  ...
  for (let i = 1; i <= count; i++) {
    ...
    products.push({
      ...
      collection: isNewArrival
        ...
        : isBestSeller
          ? "Best Seller"
          : collectionsList[i % collectionsList.length],
