...
import { 
  ArrowRight, Landmark, ShieldCheck, Gem, Sparkles, 
  Triangle, Bug, Key, Feather, Crown, Eye,
  HeartHandshake, Leaf, MapPin, Award
} from 'lucide-react';
    ...
    <div className="w-full bg-[#FCFAF7] text-[#2D2A26] font-sans overflow-hidden pt-16">
      ...
      <section className="relative w-full min-h-[90vh] flex items-center justify-start overflow-hidden bg-[#FCFAF7]">
        ...
        <div className="relative z-10 w-full max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-16 pt-24 pb-16">
          ...
          >
            <Feather className="w-8 h-8 text-[#B88932] mb-6 drop-shadow-sm" strokeWidth={1.5} />
            ...
            <h2 className="text-2xl md:text-3xl font-serif text-[#B88932] mb-6 leading-snug drop-shadow-sm">
              From Ancient Roots,<br/>To Modern Legacy.
            </h2>
            <p className="text-[#2D2A26] font-medium text-lg leading-relaxed mb-10 opacity-90 drop-shadow-sm">
              AURA is more than a brand — it's a revival of Egypt's timeless spirit. Blending ancient symbols with modern design, we craft pieces that carry history into the future.
            </p>
            <motion.button 
            ...
            >
              <span className="uppercase tracking-widest text-xs font-semibold">Our Journey</span>
        ...
        <div className="relative z-10 w-full max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-16 pt-24 pb-16 flex justify-end">
          ...
          >
            ...
            <div className="space-y-6 text-[#2D2A26] font-medium text-lg leading-relaxed opacity-90 drop-shadow-sm">
              <p>
                Born from a deep love for Egypt's rich heritage, AURA was created to reconnect the past with the present. Every design is inspired by ancient civilizations, powerful symbols, and the eternal beauty of our culture.
              </p>
              <p>
                We believe that what we wear is more than fabric — it's identity, pride, and legacy. Our garments are meticulously crafted to embody the elegance of our ancestors while serving the modern wardrobe.
              </p>
        ...
        <div className="relative z-10 w-full max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-16 flex flex-col items-center">
          <div className="flex flex-col items-center mb-16">
            ...
            <div className="flex items-center gap-[2px]">
              ...
              <img src={scarabIcon} alt="Divider" className="w-16 h-16 object-contain drop-shadow-[0_0_6px_rgba(184,137,50,0.6)]" />
              <div className="w-24 h-[1px] lg:h-[1.5px] bg-[#B88932] opacity-70"></div>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-center lg:items-start justify-center w-full gap-y-12 lg:gap-y-0">
            {[
              { imgIcon: pyramidIcon, title: 'Heritage', desc: 'We honor ancient Egypt and keep its legacy alive in everything we create.' },
              { imgIcon: scarabIcon, title: 'Authenticity', desc: 'Every detail is inspired by real history, not just passing trends.' },
              { imgIcon: eyeIcon, title: 'Quality', desc: 'We use premium materials and fine craftsmanship to deliver excellence.' },
              { imgIcon: ankhIcon, title: 'Timeless Design', desc: 'Our pieces are made to be timeless, just like the legacy we represent.' },
            ].map((value, i, arr) => (
              <div key={i} className="flex flex-col lg:flex-row items-center lg:items-start w-full lg:w-1/4">
                {/* Content Column */}
                <div className="flex flex-col items-center text-center px-4 sm:px-8 group">
                  <img src={value.imgIcon} alt={value.title} className="w-16 h-16 object-contain mb-6 drop-shadow-[0_0_8px_rgba(184,137,50,0.4)] transform group-hover:scale-110 transition-transform duration-500" />
                  <h4 className="text-[#B88932] font-bold tracking-widest uppercase text-sm mb-4">{value.title}</h4>
                  <p className="text-white text-sm leading-relaxed max-w-[250px] opacity-90">{value.desc}</p>
                </div>
      ...
      <section className="relative w-full bg-[#FCFAF7] py-16 lg:py-20">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-16 flex flex-col items-center">
          ...
          <div className="relative w-full">
            ...
            >
              {[
                { imgIcon: pyramidIcon, year: '2021', title: 'The Idea', desc: 'A spark of inspiration to revive Egypt\'s heritage.' },
                { imgIcon: scarabIcon, year: '2022', title: 'Beginning', desc: 'Turning our vision into designs that speak history.' },
                { imgIcon: ankhIcon, year: '2023', title: 'First Collection', desc: 'Our first collection launched — where ancient meets modern.' },
                { imgIcon: eyeIcon, year: '2024', title: 'Growing Legacy', desc: 'Expanding our family and sharing our story with the world.' },
                { imgIcon: pharaohIcon, year: 'Future', title: 'The Legacy', desc: 'Continuing to create, inspire, and leave a legacy behind.' },
              ].map((item, i, arr) => (
                <Fragment key={i}>
                  <motion.div 
                    variants={fadeUp}
                  ...
                  >
                    <div className="h-20 flex items-center justify-center mb-6 group-hover:-translate-y-2 transition-transform duration-500">
                      <img src={item.imgIcon} alt={item.title} className="w-16 h-16 lg:w-20 lg:h-20 object-contain drop-shadow-[0_0_8px_rgba(184,137,50,0.4)] group-hover:drop-shadow-[0_0_12px_rgba(184,137,50,0.7)] group-hover:scale-110 transition-all duration-500" />
                    </div>
                    <h5 className="text-[#B88932] font-serif font-bold text-2xl tracking-wider drop-shadow-sm mb-2">{item.year}</h5>
                    <h6 className="text-[#2D2A26] font-bold text-sm uppercase tracking-widest mb-3">{item.title}</h6>
                    <p className="text-[#6F6A63] text-sm max-w-[200px] leading-relaxed">{item.desc}</p>
                  </motion.div>
          ...
          <div className="w-full lg:w-1/2 py-12 lg:py-16 lg:pl-16 flex flex-col justify-center bg-[#FCFAF7] lg:bg-transparent">
            ...
            >
              ...
              <p className="text-[#6F6A63] font-serif italic text-base leading-loose mb-12 opacity-90">
                Behind every AURA piece, there are skilled hands, careful attention to detail, and a passion for perfection. We work with local artisans who share our belief that true beauty lies in heritage and craftsmanship.
              </p>
                ...
                {[
                  ...
                  <Fragment key={i}>
                    <div className="flex flex-col items-center text-center gap-3 group w-[45%] lg:w-auto">
                      <item.icon className="w-6 h-6 text-[#B88932] group-hover:scale-110 transition-transform" strokeWidth={1.5} />
                      <span className="text-xs font-bold uppercase tracking-widest text-[#2D2A26] leading-relaxed max-w-[120px]">{item.text}</span>
                    </div>
                    {i !== arr.length - 1 && (
      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-6 mb-4">
            ...
            <img src={scarabIcon} alt="AURA Icon" className="w-20 h-16 md:w-28 md:h-20 object-contain drop-shadow-[0_0_12px_rgba(184,137,50,0.8)]" />
            <div className="w-12 md:w-24 h-[1px] bg-[#B88932] opacity-60 shadow-[0_0_8px_rgba(184,137,50,0.8)]"></div>
          </div>
          ...
          <Link to="/collections" className="group flex items-center gap-4 px-10 py-3 bg-white/10 border border-[#E3CD91]/60 text-white hover:bg-white/20 hover:border-white shadow-lg hover:shadow-[0_0_20px_rgba(255,255,255,0.3)] transition-all duration-300 rounded-sm backdrop-blur-sm">
            <span className="uppercase tracking-widest text-sm font-semibold">Explore Collection</span>
            <ArrowRight className="w-4 h-4 transform group-hover:translate-x-1 transition-transform" />
          </Link>
        </motion.div>
      </section>
