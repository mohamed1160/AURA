    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <Heart className={cn("w-4 h-4", isWishlisted && "fill-[#C79A3B] text-[#C79A3B] group-hover:fill-white")} />
          </button>
        </div>
        ...
        <div className="p-5 flex flex-col flex-1 relative z-10 bg-[#FCFAF6]">
          ...
          <div className="flex items-center gap-2 mb-4">
            <span className="text-sm font-bold text-[#C79A3B]">EGP {product.price}</span>
            {product.oldPrice && (
              <span className="text-xs text-[#8C8C8C] line-through">EGP {product.oldPrice}</span>
            )}
          </div>
          ...
          >
            ...
            {product.stock > 0 && (
              <svg className="w-3 h-3 transform group-hover/btn:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
