...
export default function Contact() {
  ...
  const faqs = [
    { question: "How long does shipping take?", answer: "Domestic orders typically arrive within 3-5 business days. International shipping can take 7-14 business days depending on the destination." },
    { question: "What is your return policy?", answer: "We offer a 14-day return policy for all unused items in their original packaging. Custom pieces are non-refundable." },
    { question: "Do you ship internationally?", answer: "Yes, we ship worldwide. Shipping costs are calculated at checkout based on your location." },
    { question: "How can I track my order?", answer: "Once your order ships, you will receive a tracking number via email to monitor its journey." },
  ];
  ...
  return (
    <div className="w-full bg-[#FCFAF7] min-h-screen pt-16">
      ...
      <section className="relative w-full h-[60vh] md:h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        >
          <img src={pharaohIcon} alt="AURA" className="w-24 h-24 object-contain mb-4 drop-shadow-2xl" />
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <img src={scarabIcon} alt="Scarab" className="w-6 h-6 object-contain" />
            <div className="w-12 h-[1px] bg-[#E3CD91] shadow-lg"></div>
          </div>
          
          <p className="text-[#F6F4F0] text-lg md:text-xl font-medium tracking-wide drop-shadow-md">
            We would love to hear from you.<br/>
            Reach out to us for any inquiries, collaborations,<br/>
            or support.
          </p>
        </motion.div>
      </section>
        ...
        >
          <div className="text-center mb-10">
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              <img src={scarabIcon} alt="Scarab" className="w-4 h-4 object-contain opacity-60" />
              <div className="w-8 h-[1px] bg-[#B88932]/40"></div>
            </div>
          </div>
          ...
          <form className="flex flex-col gap-6">
            ...
            <button 
              ...
              onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#B88932'}
            >
              <span className="uppercase tracking-[0.2em] text-sm font-bold">Send Message</span>
      ...
      <section className="w-full max-w-6xl mx-auto px-4 pb-24">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 divide-y md:divide-y-0 md:divide-x divide-[#D1C6B4]/30">
          ...
          >
            ...
            <h3 className="text-sm font-bold tracking-widest uppercase text-[#2D2A26] mb-3">Email Us</h3>
            <a href="mailto:hello@auraluxury.com" className="text-lg font-serif text-[#6F6A63] hover:text-[#B88932] transition-colors mb-2">
          ...
          >
            ...
            <h3 className="text-sm font-bold tracking-widest uppercase text-[#2D2A26] mb-3">Call Us</h3>
            <a href="tel:+201234567890" className="text-lg font-serif text-[#6F6A63] hover:text-[#B88932] transition-colors mb-2">
              +20 123 456 7890
            </a>
          ...
          >
            ...
            <h3 className="text-sm font-bold tracking-widest uppercase text-[#2D2A26] mb-3">Working Hours</h3>
            <p className="text-lg font-serif text-[#6F6A63] mb-2">Mon - Sat: 10AM - 6PM</p>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              <img src={scarabIcon} alt="Scarab" className="w-12 h-12 object-contain opacity-60" />
              <div className="w-12 h-[1px] bg-[#B88932]/40"></div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
            {faqs.map((faq, index) => (
              ...
              >
                ...
                >
                  <span className="text-sm font-medium text-[#2D2A26] pr-4">{faq.question}</span>
                  <Plus className={`w-5 h-5 text-[#B88932] transform transition-transform duration-300 ${openFaq === index ? 'rotate-45' : ''}`} strokeWidth={1.5} />
                </button>
                <div 
          ...
          <div className="text-center mt-12">
            <p className="text-[#6F6A63] text-sm">
              Still have questions? Visit our <a href="#" className="text-[#B88932] hover:underline">FAQ page</a> <ArrowRight className="inline w-3 h-3 ml-1" />
            </p>
          </div>
        </div>
      </section>
