  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/shop"               element={<ComingSoon name="Shop" />} />
        <Route path="/shop/:category"     element={<ComingSoon name="Category" />} />
        ...
        {/* ── Brand Pages ── */}
        <Route path="/our-story"          element={<ComingSoon name="Our Story" />} />
