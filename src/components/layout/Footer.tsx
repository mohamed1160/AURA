      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 lg:px-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8 lg:gap-6 mb-8 mt-2">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left lg:col-span-1">
            <Link to="/" className="mb-4 flex flex-col items-center md:items-start group">
              <img src={scarabIcon} alt="AURA Logo" className="w-10 h-10 object-contain mb-2 drop-shadow-[0_0_8px_rgba(184,137,50,0.5)] group-hover:drop-shadow-[0_0_12px_rgba(184,137,50,0.8)] transition-all duration-300" />
              <h2 className="text-2xl font-serif text-[#B88932] tracking-[0.2em] uppercase">AURA</h2>
            </Link>
            
            <p className="text-[#D1C6B4] text-xs leading-relaxed mb-6 max-w-xs">
              We don't follow trends. We wear legacy. Handcrafted premium apparel for the modern pharaoh.
            </p>

            <div className="flex flex-col gap-3 mb-6">
              <a href="mailto:support@aura.com" className="flex items-center justify-center md:justify-start gap-3 text-[#D1C6B4] hover:text-[#B88932] transition-colors duration-300 text-xs group">
                <Mail className="w-4 h-4 text-[#B88932] group-hover:scale-110 transition-transform" />
                support@aura.com
              </a>
              <a href="tel:+201234567890" className="flex items-center justify-center md:justify-start gap-3 text-[#D1C6B4] hover:text-[#B88932] transition-colors duration-300 text-xs group">
        ...
        <div className="border-t border-[#B88932]/20 pt-6 flex flex-col md:flex-row items-center justify-between gap-4 text-center">
          ...
          <div className="flex items-center gap-2">
            ...
            <img src={scarabIcon} alt="Scarab" className="w-5 h-5 object-contain opacity-50" />
            <div className="w-6 h-[1px] bg-[#B88932] opacity-40"></div>
          </div>
          <p className="text-[#D1C6B4]/60 text-xs tracking-wide">
            Designed for Legacy
